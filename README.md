...
## 2️⃣ Day 2
- [Operator Shorthand](day_2/operator_shorthand.py)
- [While Loop](day_2/while_loops.py)
- [Nested While Loops](day_2/while_nested.py)
- [Sum N Natural Numbers (While Loop)](day_2/sum_n_natural_numbers_while.py)
- [Sum Squares](day_2/sum_squares.py)
- [Factorial (While Loop)](day_2/factorial.py)
- [Range Object](day_2/range_object.py)
- [For Loops](day_2/for_loops.py)
- [Sum N Natural Numbers (For Loop)](day_2/sum_n_natural_numbers_for.py)
- [Sum Squares (For Loop)](day_2/sum_squares_for.py)
...
- [Sum Squares](day_3/sum_squares.py)
- [Combinatorics](day_3/combinatorics.py)
- [Lists](day_3/lists.py)
